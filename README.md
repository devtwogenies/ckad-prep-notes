...
- [Practice Exam for Certified Kubernetes Application Developer (CKAD) Certification](https://www.katacoda.com/fabito/scenarios/ckad)
...
alias kcryaml='kubectl create --dry-run=client -o yaml'
```
